...
let favoriteFoods = [ 'pizza', 'salsa', 'tacos'];
...
console.log('Addded a food to the end,', favoriteFoods);
...
console.log('The food list is now', favoriteFoods);
